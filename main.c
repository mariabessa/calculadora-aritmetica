...
int main(int argc, char**argv) {
    ...
    if (argc != 3 && argc != 4) {
        ...
        printf("\tExemplo 6 de execucao: ./exe expo 2 3\n");       //Primeiro numero corresponde ao numero base e o segundo ao expoente
        return 0;
    }
